...
/**
 * Base class that represents a row from the 'alpza_congreso' table.
 *
 *
 *
 ...
 */
abstract class BaseAlpzaCongreso extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the congreso field.
	 * @var        string
	 */
	protected $congreso;
	...
	/**
	 * Initializes internal state of BaseAlpzaCongreso object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AlpzaCongreso The current object (for fluent API support)
	 */
	public function setIdAlpzaCongreso($v)
	{
		...
		if ($this->id_alpza_congreso !== $v) {
			...
			$this->modifiedColumns[] = AlpzaCongresoPeer::ID_ALPZA_CONGRESO;
		}
	...
	public function setIdAlpzaMiembro($v)
	{
		...
		if ($this->id_alpza_miembro !== $v) {
			...
			$this->modifiedColumns[] = AlpzaCongresoPeer::ID_ALPZA_MIEMBRO;
		}
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = AlpzaCongresoPeer::NOMBRE;
		}
	...
	public function setExtracto($v)
	{
		...
		if ($this->extracto !== $v) {
			$this->extracto = $v;
			$this->modifiedColumns[] = AlpzaCongresoPeer::EXTRACTO;
		}
	...
	/**
	 * Set the value of [congreso] column.
	 *
	 * @param      string $v new value
	 * @return     AlpzaCongreso The current object (for fluent API support)
	 */
	public function setCongreso($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->congreso !== $v) {
			$this->congreso = $v;
			$this->modifiedColumns[] = AlpzaCongresoPeer::CONGRESO;
		}
	...
	public function setEstado($v)
	{
		...
		if ($this->estado !== $v || $this->isNew()) {
			$this->estado = $v;
			$this->modifiedColumns[] = AlpzaCongresoPeer::ESTADO;
		}
	...
	public function setFechaIngreso($v)
	{
		...
		if ( $this->fecha_ingreso !== null || $dt !== null ) {
			...
			)
			{
				...
				$this->modifiedColumns[] = AlpzaCongresoPeer::FECHA_INGRESO;
			}
	...
	public function setFechaEdicion($v)
	{
		...
		if ( $this->fecha_edicion !== null || $dt !== null ) {
			...
			)
			{
				...
				$this->modifiedColumns[] = AlpzaCongresoPeer::FECHA_EDICION;
			}
		} // if either are not null
	...
	public function setFechaPublicacion($v)
	{
		...
		if ( $this->fecha_publicacion !== null || $dt !== null ) {
			...
			)
			{
				...
				$this->modifiedColumns[] = AlpzaCongresoPeer::FECHA_PUBLICACION;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_alpza_congreso = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			$this->extracto = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->congreso = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->estado = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->fecha_ingreso = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->fecha_edicion = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->fecha_publicacion = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->resetModified();
			...
			return $startcol + 9; // 9 = AlpzaCongresoPeer::NUM_COLUMNS - AlpzaCongresoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating AlpzaCongreso object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AlpzaCongresoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseAlpzaCongreso:delete:pre') as $callable)
			{
			...
			if ($ret) {
				AlpzaCongresoPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseAlpzaCongreso:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseAlpzaCongreso:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseAlpzaCongreso:save:post') as $callable)
				{
					call_user_func($callable, $this, $con, $affectedRows);
				}

				AlpzaCongresoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AlpzaCongresoPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
					// should always be true here (even though technically
					// BasePeer::doInsert() can insert multiple rows).

					$this->setIdAlpzaCongreso($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += AlpzaCongresoPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AlpzaCongresoPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AlpzaCongresoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AlpzaCongresoPeer::getFieldNames($keyType);
		$result = array(
		$keys[0] => $this->getIdAlpzaCongreso(),
		$keys[1] => $this->getIdAlpzaMiembro(),
		$keys[2] => $this->getNombre(),
		$keys[3] => $this->getExtracto(),
		$keys[4] => $this->getCongreso(),
		$keys[5] => $this->getEstado(),
		$keys[6] => $this->getFechaIngreso(),
		$keys[7] => $this->getFechaEdicion(),
		$keys[8] => $this->getFechaPublicacion(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdAlpzaCongreso($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setIdAlpzaMiembro($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setNombre($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setExtracto($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setCongreso($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setEstado($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setFechaIngreso($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setFechaEdicion($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setFechaPublicacion($arr[$keys[8]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AlpzaCongresoPeer::ID_ALPZA_CONGRESO)) $criteria->add(AlpzaCongresoPeer::ID_ALPZA_CONGRESO, $this->id_alpza_congreso);
		if ($this->isColumnModified(AlpzaCongresoPeer::ID_ALPZA_MIEMBRO)) $criteria->add(AlpzaCongresoPeer::ID_ALPZA_MIEMBRO, $this->id_alpza_miembro);
		if ($this->isColumnModified(AlpzaCongresoPeer::NOMBRE)) $criteria->add(AlpzaCongresoPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(AlpzaCongresoPeer::EXTRACTO)) $criteria->add(AlpzaCongresoPeer::EXTRACTO, $this->extracto);
		if ($this->isColumnModified(AlpzaCongresoPeer::CONGRESO)) $criteria->add(AlpzaCongresoPeer::CONGRESO, $this->congreso);
		if ($this->isColumnModified(AlpzaCongresoPeer::ESTADO)) $criteria->add(AlpzaCongresoPeer::ESTADO, $this->estado);
		if ($this->isColumnModified(AlpzaCongresoPeer::FECHA_INGRESO)) $criteria->add(AlpzaCongresoPeer::FECHA_INGRESO, $this->fecha_ingreso);
		if ($this->isColumnModified(AlpzaCongresoPeer::FECHA_EDICION)) $criteria->add(AlpzaCongresoPeer::FECHA_EDICION, $this->fecha_edicion);
		if ($this->isColumnModified(AlpzaCongresoPeer::FECHA_PUBLICACION)) $criteria->add(AlpzaCongresoPeer::FECHA_PUBLICACION, $this->fecha_publicacion);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AlpzaCongresoPeer::ID_ALPZA_CONGRESO, $this->id_alpza_congreso);
	...
	/**
	 * Generic method to set the primary key (id_alpza_congreso column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AlpzaCongreso (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCongreso($this->congreso);
		...
		$copyObj->setIdAlpzaCongreso(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AlpzaCongreso Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AlpzaCongresoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AlpzaCongresoPeer();
		}
		return self::$peer;
	}
	...
	public function getAlpzaMiembro(PropelPDO $con = null)
	{
		if ($this->aAlpzaMiembro === null && ($this->id_alpza_miembro !== null)) {
			...
			/* The following can be used additionally to
			 ...
			 $this->aAlpzaMiembro->addAlpzaCongresos($this);
			 */
		}
	...
	{
		if (!$callable = sfMixer::getCallable('BaseAlpzaCongreso:'.$method))
		{
			throw new sfException(sprintf('Call to undefined method BaseAlpzaCongreso::%s', $method));
		}
