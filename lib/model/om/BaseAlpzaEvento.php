...
/**
 * Base class that represents a row from the 'alpza_evento' table.
 *
 *
 *
 ...
 */
abstract class BaseAlpzaEvento extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseAlpzaEvento object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AlpzaEvento The current object (for fluent API support)
	 */
	public function setIdAlpzaEvento($v)
	{
		...
		if ($this->id_alpza_evento !== $v) {
			...
			$this->modifiedColumns[] = AlpzaEventoPeer::ID_ALPZA_EVENTO;
		}
	...
	public function setAlpzaMiembroIdAlpzaMiembro($v)
	{
		...
		if ($this->alpza_miembro_id_alpza_miembro !== $v) {
			...
			$this->modifiedColumns[] = AlpzaEventoPeer::ALPZA_MIEMBRO_ID_ALPZA_MIEMBRO;
		}
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = AlpzaEventoPeer::NOMBRE;
		}
	...
	public function setExtracto($v)
	{
		...
		if ($this->extracto !== $v) {
			$this->extracto = $v;
			$this->modifiedColumns[] = AlpzaEventoPeer::EXTRACTO;
		}
	...
	public function setEvento($v)
	{
		...
		if ($this->evento !== $v) {
			$this->evento = $v;
			$this->modifiedColumns[] = AlpzaEventoPeer::EVENTO;
		}
	...
	public function setEstado($v)
	{
		...
		if ($this->estado !== $v || $this->isNew()) {
			$this->estado = $v;
			$this->modifiedColumns[] = AlpzaEventoPeer::ESTADO;
		}
	...
	public function setFechaIngreso($v)
	{
		...
		if ( $this->fecha_ingreso !== null || $dt !== null ) {
			...
			)
			{
				...
				$this->modifiedColumns[] = AlpzaEventoPeer::FECHA_INGRESO;
			}
	...
	public function setFechaEdicion($v)
	{
		...
		if ( $this->fecha_edicion !== null || $dt !== null ) {
			...
			)
			{
				...
				$this->modifiedColumns[] = AlpzaEventoPeer::FECHA_EDICION;
			}
		} // if either are not null
	...
	public function setFechaPublicacion($v)
	{
		...
		if ( $this->fecha_publicacion !== null || $dt !== null ) {
			...
			)
			{
				...
				$this->modifiedColumns[] = AlpzaEventoPeer::FECHA_PUBLICACION;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_alpza_evento = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			$this->evento = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			return $startcol + 9; // 9 = AlpzaEventoPeer::NUM_COLUMNS - AlpzaEventoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating AlpzaEvento object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AlpzaEventoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseAlpzaEvento:delete:pre') as $callable)
			{
			...
			if ($ret) {
				AlpzaEventoPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseAlpzaEvento:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseAlpzaEvento:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseAlpzaEvento:save:post') as $callable)
				{
					call_user_func($callable, $this, $con, $affectedRows);
				}

				AlpzaEventoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AlpzaEventoPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
					// should always be true here (even though technically
					// BasePeer::doInsert() can insert multiple rows).

					$this->setIdAlpzaEvento($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += AlpzaEventoPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AlpzaEventoPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AlpzaEventoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AlpzaEventoPeer::getFieldNames($keyType);
		$result = array(
		$keys[0] => $this->getIdAlpzaEvento(),
		$keys[1] => $this->getAlpzaMiembroIdAlpzaMiembro(),
		$keys[2] => $this->getNombre(),
		$keys[3] => $this->getExtracto(),
		$keys[4] => $this->getEvento(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdAlpzaEvento($arr[$keys[0]]);
		...
		if (array_key_exists($keys[4], $arr)) $this->setEvento($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AlpzaEventoPeer::ID_ALPZA_EVENTO)) $criteria->add(AlpzaEventoPeer::ID_ALPZA_EVENTO, $this->id_alpza_evento);
		if ($this->isColumnModified(AlpzaEventoPeer::ALPZA_MIEMBRO_ID_ALPZA_MIEMBRO)) $criteria->add(AlpzaEventoPeer::ALPZA_MIEMBRO_ID_ALPZA_MIEMBRO, $this->alpza_miembro_id_alpza_miembro);
		if ($this->isColumnModified(AlpzaEventoPeer::NOMBRE)) $criteria->add(AlpzaEventoPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(AlpzaEventoPeer::EXTRACTO)) $criteria->add(AlpzaEventoPeer::EXTRACTO, $this->extracto);
		if ($this->isColumnModified(AlpzaEventoPeer::EVENTO)) $criteria->add(AlpzaEventoPeer::EVENTO, $this->evento);
		if ($this->isColumnModified(AlpzaEventoPeer::ESTADO)) $criteria->add(AlpzaEventoPeer::ESTADO, $this->estado);
		if ($this->isColumnModified(AlpzaEventoPeer::FECHA_INGRESO)) $criteria->add(AlpzaEventoPeer::FECHA_INGRESO, $this->fecha_ingreso);
		if ($this->isColumnModified(AlpzaEventoPeer::FECHA_EDICION)) $criteria->add(AlpzaEventoPeer::FECHA_EDICION, $this->fecha_edicion);
		if ($this->isColumnModified(AlpzaEventoPeer::FECHA_PUBLICACION)) $criteria->add(AlpzaEventoPeer::FECHA_PUBLICACION, $this->fecha_publicacion);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AlpzaEventoPeer::ID_ALPZA_EVENTO, $this->id_alpza_evento);
	...
	/**
	 * Generic method to set the primary key (id_alpza_evento column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AlpzaEvento (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdAlpzaEvento(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AlpzaEvento Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AlpzaEventoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AlpzaEventoPeer();
		}
		return self::$peer;
	}
	...
	public function getAlpzaMiembro(PropelPDO $con = null)
	{
		if ($this->aAlpzaMiembro === null && ($this->alpza_miembro_id_alpza_miembro !== null)) {
			...
			/* The following can be used additionally to
			 ...
			 $this->aAlpzaMiembro->addAlpzaEventos($this);
			 */
		}
	...
	{
		if (!$callable = sfMixer::getCallable('BaseAlpzaEvento:'.$method))
		{
			throw new sfException(sprintf('Call to undefined method BaseAlpzaEvento::%s', $method));
		}
