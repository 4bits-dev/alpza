...
/**
 * Base class that represents a row from the 'alpza_beca' table.
 *
 *
 *
 ...
 */
abstract class BaseAlpzaBeca extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseAlpzaBeca object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AlpzaBeca The current object (for fluent API support)
	 */
	public function setIdAlpzaBeca($v)
	{
		...
		if ($this->id_alpza_beca !== $v) {
			...
			$this->modifiedColumns[] = AlpzaBecaPeer::ID_ALPZA_BECA;
		}
	...
	public function setAlpzaMiembroIdAlpzaMiembro($v)
	{
		...
		if ($this->alpza_miembro_id_alpza_miembro !== $v) {
			...
			$this->modifiedColumns[] = AlpzaBecaPeer::ALPZA_MIEMBRO_ID_ALPZA_MIEMBRO;
		}
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = AlpzaBecaPeer::NOMBRE;
		}
	...
	public function setExtracto($v)
	{
		...
		if ($this->extracto !== $v) {
			$this->extracto = $v;
			$this->modifiedColumns[] = AlpzaBecaPeer::EXTRACTO;
		}
	...
	public function setBeca($v)
	{
		...
		if ($this->beca !== $v) {
			$this->beca = $v;
			$this->modifiedColumns[] = AlpzaBecaPeer::BECA;
		}
	...
	public function setEstado($v)
	{
		...
		if ($this->estado !== $v || $this->isNew()) {
			$this->estado = $v;
			$this->modifiedColumns[] = AlpzaBecaPeer::ESTADO;
		}
	...
	public function setFechaIngreso($v)
	{
		...
		if ( $this->fecha_ingreso !== null || $dt !== null ) {
			...
			)
			{
				...
				$this->modifiedColumns[] = AlpzaBecaPeer::FECHA_INGRESO;
			}
	...
	public function setFechaEdicion($v)
	{
		...
		if ( $this->fecha_edicion !== null || $dt !== null ) {
			...
			)
			{
				...
				$this->modifiedColumns[] = AlpzaBecaPeer::FECHA_EDICION;
			}
		} // if either are not null
	...
	public function setFechaPublicacion($v)
	{
		...
		if ( $this->fecha_publicacion !== null || $dt !== null ) {
			...
			)
			{
				...
				$this->modifiedColumns[] = AlpzaBecaPeer::FECHA_PUBLICACION;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_alpza_beca = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			$this->beca = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			return $startcol + 9; // 9 = AlpzaBecaPeer::NUM_COLUMNS - AlpzaBecaPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating AlpzaBeca object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AlpzaBecaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseAlpzaBeca:delete:pre') as $callable)
			{
			...
			if ($ret) {
				AlpzaBecaPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseAlpzaBeca:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseAlpzaBeca:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseAlpzaBeca:save:post') as $callable)
				{
					call_user_func($callable, $this, $con, $affectedRows);
				}

				AlpzaBecaPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AlpzaBecaPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
					// should always be true here (even though technically
					// BasePeer::doInsert() can insert multiple rows).

					$this->setIdAlpzaBeca($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += AlpzaBecaPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AlpzaBecaPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AlpzaBecaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AlpzaBecaPeer::getFieldNames($keyType);
		$result = array(
		$keys[0] => $this->getIdAlpzaBeca(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdAlpzaBeca($arr[$keys[0]]);
		...
		if (array_key_exists($keys[4], $arr)) $this->setBeca($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AlpzaBecaPeer::ID_ALPZA_BECA)) $criteria->add(AlpzaBecaPeer::ID_ALPZA_BECA, $this->id_alpza_beca);
		if ($this->isColumnModified(AlpzaBecaPeer::ALPZA_MIEMBRO_ID_ALPZA_MIEMBRO)) $criteria->add(AlpzaBecaPeer::ALPZA_MIEMBRO_ID_ALPZA_MIEMBRO, $this->alpza_miembro_id_alpza_miembro);
		if ($this->isColumnModified(AlpzaBecaPeer::NOMBRE)) $criteria->add(AlpzaBecaPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(AlpzaBecaPeer::EXTRACTO)) $criteria->add(AlpzaBecaPeer::EXTRACTO, $this->extracto);
		if ($this->isColumnModified(AlpzaBecaPeer::BECA)) $criteria->add(AlpzaBecaPeer::BECA, $this->beca);
		if ($this->isColumnModified(AlpzaBecaPeer::ESTADO)) $criteria->add(AlpzaBecaPeer::ESTADO, $this->estado);
		if ($this->isColumnModified(AlpzaBecaPeer::FECHA_INGRESO)) $criteria->add(AlpzaBecaPeer::FECHA_INGRESO, $this->fecha_ingreso);
		if ($this->isColumnModified(AlpzaBecaPeer::FECHA_EDICION)) $criteria->add(AlpzaBecaPeer::FECHA_EDICION, $this->fecha_edicion);
		if ($this->isColumnModified(AlpzaBecaPeer::FECHA_PUBLICACION)) $criteria->add(AlpzaBecaPeer::FECHA_PUBLICACION, $this->fecha_publicacion);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AlpzaBecaPeer::ID_ALPZA_BECA, $this->id_alpza_beca);
	...
	/**
	 * Generic method to set the primary key (id_alpza_beca column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AlpzaBeca (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdAlpzaBeca(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AlpzaBeca Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AlpzaBecaPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AlpzaBecaPeer();
		}
		return self::$peer;
	}
	...
	public function getAlpzaMiembro(PropelPDO $con = null)
	{
		if ($this->aAlpzaMiembro === null && ($this->alpza_miembro_id_alpza_miembro !== null)) {
			...
			/* The following can be used additionally to
			 ...
			 $this->aAlpzaMiembro->addAlpzaBecas($this);
			 */
		}
	...
	{
		if (!$callable = sfMixer::getCallable('BaseAlpzaBeca:'.$method))
		{
			throw new sfException(sprintf('Call to undefined method BaseAlpzaBeca::%s', $method));
		}
