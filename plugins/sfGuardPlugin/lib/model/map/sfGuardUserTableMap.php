...
class sfGuardUserTableMap extends TableMap {
	...
	{
		$this->addRelation('AlpzaMiembroAsignado', 'AlpzaMiembroAsignado', RelationMap::ONE_TO_MANY, array('id' => 'id_sf_guard_user', ), null, null);
		...
		$this->addRelation('SfGuardProfile', 'SfGuardProfile', RelationMap::ONE_TO_MANY, array('id' => 'id_sf_guard_user', ), null, null);
	} // buildRelations()
