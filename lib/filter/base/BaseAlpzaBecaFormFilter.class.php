...
/**
 * AlpzaBeca filter form base class.
 *
 * @package    alpzaDev
 * @subpackage filter
 * @author     Your name here
 */
abstract class BaseAlpzaBecaFormFilter extends BaseFormFilterPropel
{
	public function setup()
	{
      ...
      'beca'                           => new sfWidgetFormFilterInput(),
      ...
      'beca'                           => new sfValidatorPass(array('required' => false)),
      ...
      'fecha_publicacion'              => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDate(array('required' => false)))),
		...
		$this->widgetSchema->setNameFormat('alpza_beca_filters[%s]');
