...
class BasesfGuardAuthActions extends sfActions {
	...
	public function executeSingincustom($http) {
		$user = $this->getUser();
		...
		if ($http->isMethod('post')) {
			...
			//$user->setReferer($this->getContext()->getActionStack()->getSize() > 1 ? $http->getUri() : $http->getReferer());
			return $this->redirect("http://localhost/alpza/");
		}
	}
