...
/**
 * Base class that represents a row from the 'alpza_junta' table.
 *
 *
 *
 ...
 */
abstract class BaseAlpzaJunta extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the vicepresidente field.
	 * @var        string
	 */
	protected $vicepresidente;
	...
	/**
	 * The value for the fiscal field.
	 * @var        string
	 */
	protected $fiscal;

	/**
	 * The value for the director_ejecutivo field.
	 * @var        string
	 */
	protected $director_ejecutivo;
	...
	/**
	 * Initializes internal state of BaseAlpzaJunta object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [vicepresidente] column value.
	 *
	 * @return     string
	 */
	...
	/**
	 * Get the [director_ejecutivo] column value.
	 *
	 * @return     string
	 */
	public function getDirectorEjecutivo()
	{
		return $this->director_ejecutivo;
	}
	 ...
	 * @return     AlpzaJunta The current object (for fluent API support)
	 */
	public function setIdAlpzaJunta($v)
	{
		...
		if ($this->id_alpza_junta !== $v) {
			...
			$this->modifiedColumns[] = AlpzaJuntaPeer::ID_ALPZA_JUNTA;
		}
	...
	public function setIdAlpzaMiembro($v)
	{
		...
		if ($this->id_alpza_miembro !== $v) {
			...
			$this->modifiedColumns[] = AlpzaJuntaPeer::ID_ALPZA_MIEMBRO;
		}
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = AlpzaJuntaPeer::NOMBRE;
		}
	...
	public function setPresidente($v)
	{
		...
		if ($this->presidente !== $v) {
			$this->presidente = $v;
			$this->modifiedColumns[] = AlpzaJuntaPeer::PRESIDENTE;
		}
	...
	/**
	 * Set the value of [vicepresidente] column.
	 *
	 * @param      string $v new value
	 * @return     AlpzaJunta The current object (for fluent API support)
	 */
	public function setVicepresidente($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->vicepresidente !== $v) {
			$this->vicepresidente = $v;
			$this->modifiedColumns[] = AlpzaJuntaPeer::VICEPRESIDENTE;
		}
	...
	public function setSecretario($v)
	{
		...
		if ($this->secretario !== $v) {
			$this->secretario = $v;
			$this->modifiedColumns[] = AlpzaJuntaPeer::SECRETARIO;
		}
	...
	public function setTesorero($v)
	{
		...
		if ($this->tesorero !== $v) {
			$this->tesorero = $v;
			$this->modifiedColumns[] = AlpzaJuntaPeer::TESORERO;
		}
	...
	/**
	 * Set the value of [fiscal] column.
	 *
	 * @param      string $v new value
	 * @return     AlpzaJunta The current object (for fluent API support)
	 */
	public function setFiscal($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->fiscal !== $v) {
			$this->fiscal = $v;
			$this->modifiedColumns[] = AlpzaJuntaPeer::FISCAL;
		}
	...
	/**
	 * Set the value of [director_ejecutivo] column.
	 *
	 * @param      string $v new value
	 * @return     AlpzaJunta The current object (for fluent API support)
	 */
	public function setDirectorEjecutivo($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->director_ejecutivo !== $v) {
			$this->director_ejecutivo = $v;
			$this->modifiedColumns[] = AlpzaJuntaPeer::DIRECTOR_EJECUTIVO;
		}

		return $this;
	} // setDirectorEjecutivo()
	...
	public function setEstado($v)
	{
		...
		if ($this->estado !== $v || $this->isNew()) {
			$this->estado = $v;
			$this->modifiedColumns[] = AlpzaJuntaPeer::ESTADO;
		}
	...
	public function setFechaIngreso($v)
	{
		...
		if ( $this->fecha_ingreso !== null || $dt !== null ) {
			...
			)
			{
				...
				$this->modifiedColumns[] = AlpzaJuntaPeer::FECHA_INGRESO;
			}
	...
	public function setFechaEdicion($v)
	{
		...
		if ( $this->fecha_edicion !== null || $dt !== null ) {
			...
			)
			{
				...
				$this->modifiedColumns[] = AlpzaJuntaPeer::FECHA_EDICION;
			}
		} // if either are not null
	...
	public function setFechaPublicacion($v)
	{
		...
		if ( $this->fecha_publicacion !== null || $dt !== null ) {
			...
			)
			{
				...
				$this->modifiedColumns[] = AlpzaJuntaPeer::FECHA_PUBLICACION;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_alpza_junta = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			$this->vicepresidente = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			$this->fiscal = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->director_ejecutivo = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->estado = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->fecha_ingreso = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->fecha_edicion = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->fecha_publicacion = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->resetModified();
			...
			return $startcol + 13; // 13 = AlpzaJuntaPeer::NUM_COLUMNS - AlpzaJuntaPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating AlpzaJunta object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AlpzaJuntaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseAlpzaJunta:delete:pre') as $callable)
			{
			...
			if ($ret) {
				AlpzaJuntaPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseAlpzaJunta:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseAlpzaJunta:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseAlpzaJunta:save:post') as $callable)
				{
					call_user_func($callable, $this, $con, $affectedRows);
				}

				AlpzaJuntaPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AlpzaJuntaPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
					// should always be true here (even though technically
					// BasePeer::doInsert() can insert multiple rows).

					$this->setIdAlpzaJunta($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += AlpzaJuntaPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AlpzaJuntaPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AlpzaJuntaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 6:
				...
				break;
			case 7:
				return $this->getFiscal();
				break;
			case 8:
				return $this->getDirectorEjecutivo();
				break;
			case 9:
	...
	{
		$keys = AlpzaJuntaPeer::getFieldNames($keyType);
		$result = array(
		$keys[0] => $this->getIdAlpzaJunta(),
		$keys[1] => $this->getIdAlpzaMiembro(),
		$keys[2] => $this->getNombre(),
		$keys[3] => $this->getPresidente(),
		$keys[4] => $this->getVicepresidente(),
		$keys[5] => $this->getSecretario(),
		$keys[6] => $this->getTesorero(),
		$keys[7] => $this->getFiscal(),
		$keys[8] => $this->getDirectorEjecutivo(),
		$keys[9] => $this->getEstado(),
		$keys[10] => $this->getFechaIngreso(),
		$keys[11] => $this->getFechaEdicion(),
		$keys[12] => $this->getFechaPublicacion(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 6:
				...
				break;
			case 7:
				$this->setFiscal($value);
				break;
			case 8:
				$this->setDirectorEjecutivo($value);
				break;
			case 9:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdAlpzaJunta($arr[$keys[0]]);
		...
		if (array_key_exists($keys[4], $arr)) $this->setVicepresidente($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setSecretario($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setTesorero($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setFiscal($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setDirectorEjecutivo($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setEstado($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setFechaIngreso($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setFechaEdicion($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setFechaPublicacion($arr[$keys[12]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AlpzaJuntaPeer::ID_ALPZA_JUNTA)) $criteria->add(AlpzaJuntaPeer::ID_ALPZA_JUNTA, $this->id_alpza_junta);
		if ($this->isColumnModified(AlpzaJuntaPeer::ID_ALPZA_MIEMBRO)) $criteria->add(AlpzaJuntaPeer::ID_ALPZA_MIEMBRO, $this->id_alpza_miembro);
		if ($this->isColumnModified(AlpzaJuntaPeer::NOMBRE)) $criteria->add(AlpzaJuntaPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(AlpzaJuntaPeer::PRESIDENTE)) $criteria->add(AlpzaJuntaPeer::PRESIDENTE, $this->presidente);
		if ($this->isColumnModified(AlpzaJuntaPeer::VICEPRESIDENTE)) $criteria->add(AlpzaJuntaPeer::VICEPRESIDENTE, $this->vicepresidente);
		if ($this->isColumnModified(AlpzaJuntaPeer::SECRETARIO)) $criteria->add(AlpzaJuntaPeer::SECRETARIO, $this->secretario);
		if ($this->isColumnModified(AlpzaJuntaPeer::TESORERO)) $criteria->add(AlpzaJuntaPeer::TESORERO, $this->tesorero);
		if ($this->isColumnModified(AlpzaJuntaPeer::FISCAL)) $criteria->add(AlpzaJuntaPeer::FISCAL, $this->fiscal);
		if ($this->isColumnModified(AlpzaJuntaPeer::DIRECTOR_EJECUTIVO)) $criteria->add(AlpzaJuntaPeer::DIRECTOR_EJECUTIVO, $this->director_ejecutivo);
		if ($this->isColumnModified(AlpzaJuntaPeer::ESTADO)) $criteria->add(AlpzaJuntaPeer::ESTADO, $this->estado);
		if ($this->isColumnModified(AlpzaJuntaPeer::FECHA_INGRESO)) $criteria->add(AlpzaJuntaPeer::FECHA_INGRESO, $this->fecha_ingreso);
		if ($this->isColumnModified(AlpzaJuntaPeer::FECHA_EDICION)) $criteria->add(AlpzaJuntaPeer::FECHA_EDICION, $this->fecha_edicion);
		if ($this->isColumnModified(AlpzaJuntaPeer::FECHA_PUBLICACION)) $criteria->add(AlpzaJuntaPeer::FECHA_PUBLICACION, $this->fecha_publicacion);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AlpzaJuntaPeer::ID_ALPZA_JUNTA, $this->id_alpza_junta);
	...
	/**
	 * Generic method to set the primary key (id_alpza_junta column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AlpzaJunta (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setVicepresidente($this->vicepresidente);

		$copyObj->setSecretario($this->secretario);

		$copyObj->setTesorero($this->tesorero);

		$copyObj->setFiscal($this->fiscal);

		$copyObj->setDirectorEjecutivo($this->director_ejecutivo);
		...
		$copyObj->setIdAlpzaJunta(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AlpzaJunta Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AlpzaJuntaPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AlpzaJuntaPeer();
		}
		return self::$peer;
	}
	...
	public function getAlpzaMiembro(PropelPDO $con = null)
	{
		if ($this->aAlpzaMiembro === null && ($this->id_alpza_miembro !== null)) {
			...
			/* The following can be used additionally to
			 ...
			 $this->aAlpzaMiembro->addAlpzaJuntas($this);
			 */
		}
	...
	{
		if (!$callable = sfMixer::getCallable('BaseAlpzaJunta:'.$method))
		{
			throw new sfException(sprintf('Call to undefined method BaseAlpzaJunta::%s', $method));
		}
