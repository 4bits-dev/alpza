...
/**
 * AlpzaEvento filter form base class.
 *
 * @package    alpzaDev
 * @subpackage filter
 * @author     Your name here
 */
abstract class BaseAlpzaEventoFormFilter extends BaseFormFilterPropel
{
	public function setup()
	{
      ...
      'evento'                         => new sfWidgetFormFilterInput(),
      ...
      'fecha_publicacion'              => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDate(array('required' => false)))),
		...
		$this->widgetSchema->setNameFormat('alpza_evento_filters[%s]');
