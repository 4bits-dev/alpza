...
/**
 * This class defines the structure of the 'alpza_noticia' table.
 *
 *
 ...
 */
class AlpzaNoticiaTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.AlpzaNoticiaTableMap';
	...
	{
		// attributes
		$this->setName('alpza_noticia');
		$this->setPhpName('AlpzaNoticia');
		$this->setClassname('AlpzaNoticia');
		$this->setPackage('lib.model');
		$this->setUseIdGenerator(true);
		// columns
		$this->addPrimaryKey('ID_ALPZA_NOTICIA', 'IdAlpzaNoticia', 'INTEGER', true, null, null);
		...
		$this->addColumn('NOTICIA', 'Noticia', 'LONGVARCHAR', false, null, null);
